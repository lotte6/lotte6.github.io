function loadmore(url){
  ...
  $.ajax({
    ...
    success:  function(data) {
      ...
      // console.log($(data).find("div #container").text());
      $("#container").html($(data).find("div #container"));
      // document.getElementById("container").innerHTML=$(data).find("div #container").text()
    }
  }); 
